...
description: (Deprecated) 게임 카테고리 미니앱에서 프로모션 코드로 리워드를 지급합니다. 대신 grantPromotionReward를 사용하세요.
---
...
:::caution Deprecated
`grantPromotionRewardForGame`은 더 이상 사용되지 않습니다. 대신 [`grantPromotionReward`](./grantPromotionReward)를 사용하세요. 모든 카테고리에서 동작하며 에러 코드가 동일합니다.
:::
...
- [`grantPromotionReward`](./grantPromotionReward) — 모든 카테고리에서 사용 가능한 후속 함수.
