...
| One-off | [`onVisibilityChangedByTransparentServiceWeb`](/api/events/onVisibilityChangedByTransparentServiceWeb) | Transparent service web visibility. Not part of the `addEventListener` family, but uses the same cleanup pattern. |
...
[`onVisibilityChangedByTransparentServiceWeb`](/api/events/onVisibilityChangedByTransparentServiceWeb) isn't part of the `addEventListener` family but follows **the same cleanup contract**.
...
- [`onVisibilityChangedByTransparentServiceWeb`](/api/events/onVisibilityChangedByTransparentServiceWeb) — transparent service web visibility.
