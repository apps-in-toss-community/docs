...
- [`getAnonymousKey`](./getAnonymousKey) — Recommended replacement. Identical type and behavior.
- [`appLogin`](./appLogin) — Toss account-based login flow.
- [`getGameCenterGameProfile`](/api/game/getGameCenterGameProfile) — Fetch the Game Center profile.

## Related guides

- [Guides — Anonymous key patterns for game session identification](/guides/anonymous-key-game-session)
