...
- [`getUserKeyForGame`](./getUserKeyForGame) — (Deprecated) Issue an anonymous key for game sessions.

## Related guides

- _(coming soon)_ Recipes — Game Center profile integration patterns
